...
### High Severity
- Hooks (`.cursor/hooks/*.sh`) that execute malicious or undisclosed shell
...
### Out of Scope
- The behavior of Cursor itself
  (report to [Cursor](https://cursor.com))
- Bugs in the user's Cursor installation
