...
Present the inferred classification using AskQuestion:
...
Present the draft to the user in full. Then Use the AskQuestion tool with:
- prompt: "Here's the Quick Design Spec draft. How do you want to proceed?"
- options:
  - id: a, label: "Approve — write it as shown — `[B] Revise — I'll describe what to change`"
  - id: c, label: "This grew too large — redirect to /design-system instead"
