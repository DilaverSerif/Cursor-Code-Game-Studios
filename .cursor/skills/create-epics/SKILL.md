...
- options:
  - id: a, label: "Yes, create it — `[B] Skip this epic`"
  - id: c, label: "Pause — I need to write ADRs first"
...
- options:
  - id: a, label: "Proceed as planned — I accept the producer's concerns — `[B] Revise epic boundaries — split or merge as recommended`"
  - id: c, label: "Stop — I want to reconsider the scope"
Wait for the answer before continuing.
