...
**Decision Points:** At each step transition, use AskQuestion to present
...
**Gate**: Use AskQuestion to present all three Step 1 outputs (narrative brief, lore foundation, visual direction targets) and confirm before proceeding to Step 2.
...
**Gate**: Use AskQuestion to present Step 2 layout (including any unresolved adjacent area dependencies) and confirm before proceeding to Step 3.
...
**Gate**: Use AskQuestion to present Step 3 outputs and confirm before proceeding to Step 4.
...
**Gate**: Use AskQuestion to present both Step 4 results. If the accessibility-specialist returned any BLOCKING concerns, highlight them prominently and offer:
