...
This is the first thing the user sees. Use the AskQuestion tool with:
- prompt: "Welcome to Cursor Code Game Studios! Before I suggest anything, I'd like to understand where you're starting from. Where are you at with your game idea right now?"
- options:
  - id: a, label: "No idea yet — I don't have a game concept at all. I want to explore and figure out what to make."
  - id: b, label: "Vague idea — I have a rough theme, feeling, or genre in mind but nothing concrete."
  - id: c, label: "Clear concept — I know the core idea (genre, basic mechanics) but haven't formalized it yet."
  - id: d, label: "Existing work — I already have design docs, prototypes, code, or significant planning done."
...
1. Ask them to describe their concept in one sentence — genre and core mechanic. Use plain text, not AskQuestion (it's an open response).
2. Acknowledge the concept, then use AskQuestion to offer two paths:
...
**If it does not exist**: Use AskQuestion:
...
After presenting the recommended path, use AskQuestion to ask the user which step they'd like to take first. Never auto-run the next skill.
