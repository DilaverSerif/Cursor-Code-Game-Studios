...
Otherwise, use AskQuestion to confirm intent before proceeding:
...
Read `AGENTS.md` and `docs/studio/technical-preferences.md` for the engine and
language in use.
...
Assess which path best fits the hypothesis, then use AskQuestion with your
...
Read `docs/studio/templates/prototype-report.md` to get the report structure.
...
2. **Choose path** — same AskQuestion widget as Phase 3 (HTML / Engine / Paper).
