...
- The engine name and version from `docs/studio/technical-preferences.md` and `docs/engine-reference/[engine]/VERSION.md`
...
- options:
  - id: a, label: "[A] Yes — write the report"
  - id: b, label: "[B] No — skip"
Wait for the answer before continuing.

If any GDDs are flagged for revision, use a second AskQuestion:
...
After all file writes are complete, use AskQuestion for a closing widget.
