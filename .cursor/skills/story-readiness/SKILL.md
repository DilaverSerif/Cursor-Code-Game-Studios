...
**Scope:** `$ARGUMENTS[0]` (blank = ask user via AskQuestion)
...
If no argument is given, use AskQuestion:
...
- **GAPS [list]** → surface the specific gaps to the user via AskQuestion:
