...
- options:
  - id: a, label: "Run /story-done to mark the story complete — `[B] Stop here`"
  - id: a, label: "Fix the issues and re-run /code-review — `[B] Run /story-done anyway with noted exceptions`"
