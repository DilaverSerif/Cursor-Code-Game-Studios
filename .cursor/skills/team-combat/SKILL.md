...
- options:
  - id: a, label: "Proceed — spawn implementation agents (gameplay-programmer, ai-programmer, technical-artist, sound-designer) — `[B] Revise the architecture first — I'll describe what needs to change`"
  - id: c, label: "Stop here — I'll continue later"
