...
**Argument:** `$ARGUMENTS` (blank = ask user via AskQuestion)
...
then ask two questions together using AskQuestion:
...
- Use AskQuestion for scope selection when no argument is provided.
