...
After presenting the report, Use the AskQuestion tool with:
- prompt: "Balance check complete. What would you like to do next?"
- options:
  - id: a, label: "Fix highest-priority issue now — walk me through it — `[B] Save report to design/balance/balance-check-[system]-[date].md`"
  - id: c, label: "Stop here — I'll review the findings manually"
