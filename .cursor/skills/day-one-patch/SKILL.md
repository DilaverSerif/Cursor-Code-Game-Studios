...
- options:
  - id: a, label: "[A] Approve this scope"
  - id: b, label: "[B] Adjust — I want to add or remove items"
  - id: c, label: "[C] No day-one patch needed"
...
Use AskQuestion to confirm proceeding or reduce scope.
...
- options:
  - id: a, label: "Run /patch-notes — generate player-facing patch notes — `[B] Run /bug-report to log any issues found post-deploy`"
