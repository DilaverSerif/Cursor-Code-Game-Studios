...
If OFF TRACK, Use the AskQuestion tool with:
...
- options:
  - id: a, label: "Accept NO-GO — generate the full review with that recommendation — `[B] Override to CONDITIONAL GO — I'll document the accepted risks myself`"
  - id: c, label: "Stop — I want to address blockers before generating the review"
Wait for the answer before continuing.

If AT RISK, Use the AskQuestion tool with:
- prompt: "Producer verdict: AT RISK. Milestone may slip. How should the Go/No-Go section be framed?"
- options:
  - id: a, label: "CONDITIONAL GO — include producer's conditions in the review — `[B] NO-GO — conditions cannot be met in time`"
  - id: c, label: "GO — I accept the risk and want to proceed"
Wait for the answer before continuing.
