...
Then use AskQuestion to capture feedback:
...
Use AskQuestion to ask: "Does this dependency ordering look right? Any
...
Use AskQuestion to ask: "Do these priority assignments match your vision?
...
Use AskQuestion for: "Start designing [system-name] now, pick a different
system, or stop here?"
...
After `/design-system` completes, use AskQuestion:
...
After the systems index is created (or after designing some systems), present next actions using AskQuestion:
...
> `design/gdd/systems-index.md`. Open a fresh Cursor session to continue
