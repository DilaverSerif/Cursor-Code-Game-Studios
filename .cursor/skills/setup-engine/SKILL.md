...
**Question 1 — Prior experience** (ask this first, always, via AskQuestion):
...
**Question 2 — Target platform** (ask this second, always, via AskQuestion — platform eliminates or heavily weights engines before any other factor):
...
5. Use AskQuestion to confirm: "Does this recommendation feel right, or would you like to explore a different engine?"
...
Use AskQuestion with concept-specific deep-dive topics. Always generate these options from the user's actual concept — do not use generic options. Always include at minimum:
...
### Remaining Sections
- **Performance Budgets**: Use the AskQuestion tool with:
- prompt: "Should I set default performance budgets now, or leave them for later?"
- options:
  - id: a, label: "[A] Set defaults now (60fps, 16.6ms frame budget, engine-appropriate draw call limit)"
  - id: b, label: "[B] Leave as [TO BE CONFIGURED] — I'll set these when I know my target hardware"
