...
- Related skills to read when relevant: `design-review`, `balance-check`, `brainstorm`.
- Persist durable notes in project files (e.g. `production/agent-memory/`), not chat.
...
2. **Capture the decision** -- Call `AskQuestion` with concise labels and
