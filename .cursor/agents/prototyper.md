...
- Naming conventions from `docs/studio/technical-preferences.md`
...
Use template: `docs/studio/templates/prototype-report.md`

**Vertical slice** → `prototypes/[name]-vertical-slice/REPORT.md`
Use template: `docs/studio/templates/vertical-slice-report.md`
