...
## Studio framework docs (`docs/studio/`)

Templates, workflow catalog, agent roster, and coding standards for Cursor Code
Game Studios live here. Do not put game-specific architecture or ADRs in this folder.
