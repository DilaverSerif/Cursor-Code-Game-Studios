...
This is a complete Cursor agent architecture for game development. It
...
```
AGENTS.md                          -- Studio identity + collaboration (read this first)
.cursor/
  agents/                          -- 49 agent definitions
  skills/                          -- 73 slash command definitions
...
docs/studio/
    ...
    setup-requirements.md          -- System prerequisites (Git, Cursor, jq, Python)
    settings-local-template.md     -- Personal override notes
