# CCGS Skill Testing Framework — Cursor Instructions

This folder is the quality assurance layer for the Cursor Code Game Studios skill/agent
...
- Live skills: `.cursor/skills/[name]/SKILL.md`
- Live agents: `.cursor/agents/[name].md`
...
2. Read the skill at `.cursor/skills/[name]/SKILL.md`
...
Nothing in `.cursor/` imports from here. Deleting this folder has no effect on the
