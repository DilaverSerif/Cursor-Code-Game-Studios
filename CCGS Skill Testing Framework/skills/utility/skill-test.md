...
- **audit**: Produces a coverage table of all skills in `.cursor/skills/` and
  all agents in `.cursor/agents/`, showing which have spec files and which do not.
...
**Fixture:**
- `.cursor/skills/brainstorm/SKILL.md` exists and is well-formed:
...
**Expected behavior:**
1. Skill reads `.cursor/skills/brainstorm/SKILL.md`
...
**Fixture:**
- `.cursor/skills/some-skill/SKILL.md` has `Write` in `allowed-tools` frontmatter
...
- `.cursor/skills/gate-check/SKILL.md` exists
...
**Fixture:**
- `.cursor/skills/` contains 72+ skill directories
- `.cursor/agents/` contains 49+ agent files
- `tests/skills/` contains spec files for a subset of skills

**Input:** `/skill-test audit`

**Expected behavior:**
1. Skill enumerates all skills in `.cursor/skills/` and all agents in `.cursor/agents/`
...
- `.cursor/skills/gate-check/SKILL.md` is a gate skill
