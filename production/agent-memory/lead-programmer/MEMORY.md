...
### Frontmatter
- Fields: `name`, `description` (include WHEN trigger terms)
- Use the AskQuestion tool in the skill body for structured choices

### File Layout
- Skills live in `.cursor/skills/<name>/SKILL.md` (subdirectory per skill, never flat .md)
